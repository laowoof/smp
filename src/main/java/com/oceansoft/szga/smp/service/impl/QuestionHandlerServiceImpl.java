...
public class QuestionHandlerServiceImpl implements QuestionHandlerService {
    ...
    @Override
    public Map<String, Object> queryPageHandler(QuestionQueryBean questionQueryBean, SysUserVO userData) {
...
//        Page<Object> objects = PageHelper.startPage(pageNum, pageSize);
        ...
        List<Map<String, Object>> mapList = questionHandlerMapper.queryPageHandler(page, questionQueryBean, departmentId.trim(), integerList);
